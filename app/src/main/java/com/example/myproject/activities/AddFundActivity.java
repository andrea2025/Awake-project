...
Button addFund;
    ...
    ViewPager viewPager;
    private int[] layouts = {R.layout.activity_slide_row, R.layout.debit_card, R.layout.debit_card};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addFund =findViewById(R.id.BtnFund);
        ...
        FundArrow = findViewById(R.id.FundArrow);
        FundArrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),DashboardActivity.class);
                startActivity(intent);
        ...
        dotLayouts = findViewById(R.id.dotsLayoutFund);
        viewPager = findViewById(R.id.viewpagerFund);
        cardLayoutAdapter = new AddFundCardLayoutAdapter(layouts, AddFundActivity.this);
